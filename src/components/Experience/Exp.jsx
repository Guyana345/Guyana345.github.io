      ...
      <section className="resume-section p-3 p-lg-5 " id="experience">
          <div className="row my-auto">
              ...
              <div className="resume-item col-md-6 col-sm-12 " > 
                <div className="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
              ...
              <div className="resume-item col-md-6 col-sm-12">
                <div className="card mx-0 p-4 mb-5" style="border-color: #ffc107; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div className="resume-content mr-auto">
              ...
              <div className="resume-item col-md-6 col-sm-12">
                <div className="card mx-0 p-4 mb-5" style="border-color: #28a745; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div className="resume-content mr-auto">
              ...
              <div className="resume-item col-md-6 col-sm-12">
                <div className="card mx-0 p-4 mb-5" style="border-color: #2196f3; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div className="resume-content mr-auto">
